export const EstudianteTasksView = `
  ...
  <div class="table-responsive">
    <table class="admin-table">
      ...
      <tbody id="student-tasks-table-body">
        </tbody>
    </table>
  </div>
  ...
  <div id="submit-task-modal" class="modal hidden">
    <div class="modal-content auth-card">
      ...
      <form id="submit-task-form">
        ...
        <div class="input-group">
          <label for="submission-comments">Comentarios adicionales</label>
          <input type="text" id="submission-comments" placeholder="Hola profe, aquí está mi tarea...">
        </div>
